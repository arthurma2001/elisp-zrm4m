...
(defun eim-dump-env ()
  ;(message "eim-dump-env() - str=%s,key=%S"
  ;         eim-current-str eim-current-key)
  (message "guide=%S" eim-guidance-str)
   ;(message "%d - %d" (eim-current-page) (eim-total-page))
  ;(message "choice=%S"  eim-current-choices)
  ;(message "flags:%S %S %S"
  ;         input-method-use-echo-area
  ;         (null unread-command-events)
  ;         (null unread-post-input-method-events))

  ;(message "%s - %s" current-input-method-title eim-guidance-str)
  )
...
(defun eim-show ()
  ...
  (message "unread-command-events:%S" (null unread-command-events))
  (message "unread-post-input-method-events:%S"
           (null unread-post-input-method-events))
